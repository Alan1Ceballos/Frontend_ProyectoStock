...
public class verCarritoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession(false); // false significa que no se crea una nueva sesión si no existe
        ...
        if (session != null) {
            ...
            if (idVendedor != null) {
                response.getWriter().println("El ID del vendedor es: " + idVendedor);
            } else {
                response.getWriter().println("No se encontró el ID del vendedor en la sesión.");
            }
        } else {
    ...
    private void confirmarYGuardarPedido(HttpSession session, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int idVendedor = jsonObject.getInt("idVendedor");  
            ...
            jsonPedido.put("idVendedor", idVendedor);
